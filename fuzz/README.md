...
| `exfat_read`| `check` + `ExFatFs::open_with` + recursive read | boot region, entry sets across clusters, FAT and contiguous allocations, the up-case table, lookups, `parent`, the checker |
