...
|-------------|--------------------------------------|-----------|
| `cpio_read` | `CpioReader::next_entry`, partial reads and skips, `next_segment()` | newc, newc-crc, odc and old binary headers, names, sizes, checksums and concatenated archives |
