...
```toml
[dependencies]
hadris-fat = { version = "2.1.0", default-features = false, features = ["read", "write", "alloc", "lfn", "sync"] }
```
...
```toml
[dependencies]
hadris-fat = "2.1.0"  # Uses default features
```
...
```toml
[dependencies]
hadris-fat = { version = "2.1.0", default-features = false, features = ["read", "write", "alloc", "lfn", "sync", "cache"] }
```
