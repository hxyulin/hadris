...
```toml
[dependencies]
hadris-cpio = { version = "2.0.0", default-features = false, features = ["read", "sync"] }
```
...
```toml
[dependencies]
hadris-cpio = { version = "2.0.0", default-features = false, features = ["read", "alloc", "sync"] }
```
...
```toml
[dependencies]
hadris-cpio = "2.0.0"  # Uses default features
```
