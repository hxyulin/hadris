...
Hadris 2.1.0 is the current stable release of the V2 API, first stabilized in
...
Read the [2.1.0 changelog](https://github.com/hxyulin/hadris/blob/main/CHANGELOG.md#210---2026-08-18)
